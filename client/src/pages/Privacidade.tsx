    ...
    <div className="min-h-screen bg-black text-white">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-14 h-14 rounded-2xl bg-[#FB0047]/10 flex items-center justify-center">
                <Shield size={28} className="text-[#FB0047]" />
              </div>
              <h1 className="text-3xl sm:text-4xl font-bold font-display">Política de Privacidade</h1>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-24 bg-black">
        <div className="container max-w-3xl">
          <div className="glass-card p-8 sm:p-12 space-y-8 text-[#CCCCCC] leading-relaxed" style={{ lineHeight: '150%' }}>
            <div>
              <h2 className="text-xl font-bold font-display text-white mb-3">1. Informações Gerais</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold font-display text-white mb-3">2. Dados Coletados</h2>
            ...
            <div>
              <h2 className="text-xl font-bold font-display text-white mb-3">3. Finalidade</h2>
            ...
            <div>
              <h2 className="text-xl font-bold font-display text-white mb-3">4. Compartilhamento</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold font-display text-white mb-3">5. Cookies</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold font-display text-white mb-3">6. Seus Direitos</h2>
            ...
            <div>
              <h2 className="text-xl font-bold font-display text-white mb-3">7. Contato</h2>
              <p>
                Para exercer seus direitos ou esclarecer dúvidas sobre esta política, entre em contato pelo e-mail{" "}
                <a href="mailto:privacidade@autodoc.com.br" className="text-[#FB0047] hover:underline focus-visible:ring-2 focus-visible:ring-[#FB0047] focus-visible:outline-none rounded-sm">
                  privacidade@autodoc.com.br
                </a>{" "}
                ou pelo telefone{" "}
                <a href="tel:+551150437900" className="text-[#FB0047] hover:underline focus-visible:ring-2 focus-visible:ring-[#FB0047] focus-visible:outline-none rounded-sm">(11) 5043-7900</a>.
              </p>
            </div>

            <p className="text-xs text-[#5D5D5D] pt-4 border-t border-white/5">
