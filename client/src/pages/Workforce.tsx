        ...
        <div className="container">
          <SectionReveal>
            <div className="text-center mb-16">
              ...
              <p className="text-[#5D5D5D] text-lg">A transformação que o Autodoc Workforce traz para sua operação</p>
            </div>
          </SectionReveal>
      ...
      <section className="py-16 sm:py-20 lg:py-32 bg-black">
        <div className="container">
          <SectionReveal>
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold font-display mb-4">
                Checklist de <span className="gradient-text">Compliance</span> Completo
              </h2>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
              <div className="flex-1 max-w-xl">
                <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 rounded-full bg-[#FB0047]/10 border border-[#FB0047]/20">
                  ...
                  <span className="text-sm font-bold font-display text-[#FB0047]">Autodoc Catraca</span>
                </div>

                <h2 className="text-3xl sm:text-4xl font-bold font-display leading-tight mb-5" style={{ lineHeight: '120%' }}>
                  Controle de acesso com{" "}
                  <span className="gradient-text">reconhecimento facial</span>
                </h2>
              ...
              <div className="flex-1 max-w-md">
                <div className="glass-card gradient-border p-6 glow-blue">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-white font-bold font-display">Fluxo de Acesso Inteligente</p>
                  </div>
